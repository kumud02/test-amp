...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    setLoading(true); // Set loading state to true before sending email
  ...
  return (
    <>
     {loading ? (
        <Loader /> // Show the loader if loading state is true
      ) : (
    ...
    {/* <i class="fa-sharp fa-light fa-circle-check custom-icon-blue"></i> */}

      Your message has been sent successfully. We will contact you shortly.</p>
