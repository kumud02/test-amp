      ...
      <div className="container-fluid brand">
        <div className="row">
          <div className="brand success-message">
            ...
            <div class="container alert alert-success alert-dismissible d-flex align-items-center fade show text-center success-message">
    <i class="bi-check-circle-fill custom-font"></i>
