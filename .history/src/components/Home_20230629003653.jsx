...
const Home = () => {
  return (
    ...
    <div className="container-fluid background-image"> 
      ...
      <div className="container mt-4 background-image-banner">
      ...
      <div className="container-fluid mt-5 background-image-banner">
        <div className="row">
          <div className="col-10 mx-auto">
            <div className="row gx-4">
              <div className="banner">
                <div className="banner-content">
                  <h2 className="text-center">Ready to unlock your team's full potential?</h2>
