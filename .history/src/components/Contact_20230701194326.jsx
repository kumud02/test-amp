...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      ...
      .finally(() => {
        setLoading(false);
        setIsButtonDisabled(false); // Enable the button after email is sent or an error occurs
      });
  };
            ...
            <div className="col-md-6 col-10 mx-auto">
              <form onSubmit={handleSubmit}>
                ...
                <div className="my-3 d-flex justify-content-center">
                  <button type="submit" className="btn-send-email" disabled={isButtonDisabled}>
                    Send Email
                  </button>
                </div>
              </form>
