                            ...
                            <div className="container-fluid nav_bg">
                                <div className="row">
                                    <div className="col-10 mx-auto">
                                        <div className="row">
                                            <div className="col-lg-6 col-md-8 col-sm-12 pt-5 pt-lg-0 order-2 order-lg-1 d-flex justify-content-center flex-column">
                                                <h1>
                                            ...
                                            <div className="col-lg-6 col-md-8 col-sm-12 order-1 order-lg-2 header-img">
                                ...
                                <div className="banner">
                                    <div className="banner-content">
                                        ...
                                        <div className="my-3 d-flex justify-content-center">
                                            <NavLink onClick={() => window.scrollTo(0, 0)} to="/contact" className="btn-get-started">
                                                Reach Out to Us
                                            </NavLink>
                                        </div>
                                    </div>
