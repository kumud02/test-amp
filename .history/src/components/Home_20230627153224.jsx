...
const Home = () => {
  ...
  <div class="row">
    <div class="col-md-6">
      ...
      <p classtext-justify>Your dev team is capable of more. Much more. CarbonQA rapidly provides a dedicated, US-based testing team that can unlock that potential. We help your devs build better software, faster and cheaper.
